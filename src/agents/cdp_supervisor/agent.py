...
ALL_UC_FUNCTIONS = [
    ...
    "main.cdp.get_clv_rankings",
    "main.cdp.get_clv_summary",
    "main.cdp.get_channel_attribution",
    "main.cdp.get_behavioral_segments",
    "main.cdp.get_support_analytics",
    "main.cdp.get_support_kpis",
    "main.cdp.get_call_center_agents",
    "main.cdp.get_call_center_sentiment",
    "main.cdp.get_personalization_signals",
    "main.cdp.get_ad_creative",
    "main.cdp.get_campaign_roi",
    "main.cdp.get_audience",
]
