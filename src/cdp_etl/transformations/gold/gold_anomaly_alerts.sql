...
current_state AS (
  ...
  FROM main.cdp.gold_engagement_metrics e
  LEFT JOIN main.cdp.gold_health_score h ON e.golden_id = h.golden_id
  LEFT JOIN main.cdp.gold_segments s ON e.golden_id = s.golden_id
  LEFT JOIN main.cdp.gold_next_best_actions n ON e.golden_id = n.golden_id
)
SELECT
  c.golden_id,
...
LEFT JOIN main.cdp.gold_customer_360 m ON c.golden_id = m.golden_id
WHERE
